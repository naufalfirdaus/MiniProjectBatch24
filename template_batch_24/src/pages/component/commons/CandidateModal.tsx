                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            ...
                            <div className="mt-2">
                                <p className="text-sm text-gray-500">{props.candidate.username}</p>
                                <select name="switch" id="switch" defaultValue='' className='mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5'>
                                    ...
                                    <option value="2">Ready Test</option>
                                    <option value="3">Contracted</option>
                            ...
                            <div className="mt-4 flex justify-end gap-2">
                                ...
                                <button type="button" className="rounded-md border border-transparent bg-green-100 px-4 py-2 text-sm font-medium text-green-900 hover:bg-green-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2" onClick={() => props.setIsOpen(false)}>
                                    Submit
                                </button>
                            </div>
                            </Dialog.Panel>
