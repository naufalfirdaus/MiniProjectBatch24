...
import { UpdateBankRequest, GetBankReq } from '@/redux-saga/action/bankAction';
...
export default function EditBankModal(props: setModal) {
  const dispatch = useDispatch();
  const formik = useFormik({
    initialValues: {
      id: props.setId,
      bank_code: props.setBankCode,
    ...
    onSubmit: async (values: any) => {
      ...
      dispatch(UpdateBankRequest(payload));
    },
  });
          ...
          <form onSubmit={formik.handleSubmit}>
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              <div className="flex items-start justify-between px-5 py-3 border-b border-solid border-slate-200 rounded-t">
                <h3 className="text-2xl font-semibold">Add / Edit Bank</h3>
                <button
