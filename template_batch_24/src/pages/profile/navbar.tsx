...
const navigation = [
  ...
  { name: 'Fintech', href: '/fintech/bank', current: false },
];
                    ...
                    <div className="flex h-16 items-center justify-between">
                      ...
                      <div className="hidden md:block">
                        <div className="ml-4 flex items-center md:ml-6">
                          <div className="relative rounded-ful p-1 text-slate-800 hover:text-slate-950 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                      ...
                                      <a
                                        ...
                                        onClick={
                                          item.name === 'Sign out'
                                            ? handleLogout
                                            : undefined
                                        } // Call the logout function only for "Sign out"
                                        className={classNames(
                                          active ? 'bg-gray-100' : '',
