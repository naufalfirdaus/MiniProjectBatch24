...
import CardEditEmail from "./edit/cardEditEmail";
import { deleteEmailRequest } from "@/redux-saga/action/emailAction";
                        ...
                        <div className="flex items-center space-x-2">
                          <Flowbite theme={{ theme: customTheme }}>
                            <Button
                              ...
                              className="w-5 h-5"
                              onClick={() => {
                                setId(emailObj.id); // Set id before opening the modal
