...
export const CardProfileRightSide = () => {
  ...
  return (
    ...
    <Button color="add" className="w-5 h-5" onClick={() => props.setOpenModal('education-form-elements')}>
    ...
    <Modal show={props.openModal === 'education-form-elements'} size="5xl" popup onClose={() => props.setOpenModal(undefined)}>
        <Modal.Header />
        <Modal.Body>
        <CardAddEducation/>
        </Modal.Body>
