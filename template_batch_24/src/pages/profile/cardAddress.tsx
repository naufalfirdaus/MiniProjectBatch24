...
import CardEditAddress from "./edit/cardEditAddress";
import { deleteAddressRequest } from "@/redux-saga/action/addressAction";
...
const CardAddress = () => {
  ...
  const [id, setIdAddress] = useState("");
  const [pontalcode, setPontalCode] = useState("");
          ...
          <div key={index}>
            {item.userAddress.map(
              (
                ...
                <div key={addrindex} className="flow-root">
                        ...
                        <div className="flex items-center space-x-2">
                          <Flowbite theme={{ theme: customTheme }}>
                            <Button
                              ...
                              className="w-5 h-5"
                              onClick={() => {
                                setIdAddress(addressOBJ.addrId);
                                setAddress1(addressOBJ.addressLine1);
                                setAddress2(addressOBJ.addressLine2);
                                setPontalCode(addressOBJ.postalCode);
                                setCity(addressOBJ.City);
                                settype(addressOBJ.type);
                          ...
                          <Flowbite theme={{ theme: customTheme }}>
                            <Button
                              color="delete"
                              className="w-5 h-5"
                              onClick={() => onDelete(addressOBJ.addrId)}
                            >
                              <svg
