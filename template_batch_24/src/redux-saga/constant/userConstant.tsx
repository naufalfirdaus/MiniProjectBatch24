...
export const ADD_SKILL_REQ = "ADD_SKILL_REQ";
...
export const DELETE_EXPERIENCE_REQ = "DELETE_EXPERIENCE_REQ";
...
export const USER_EDIT_PROFILE_REQ = "USER_EDIT_PROFILE_REQ";
