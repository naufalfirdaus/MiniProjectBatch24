...
import { UpdateUsersRequest } from '@/redux-saga/action/usersAccountAction';
...
export default function EditUsersModal(props: setModal) {
  const [saldo, setSaldo] = useState(props.setSaldo);
  const [accountNumber, setAccountNumber] = useState(props.setUsersAcc);

  const dispatch = useDispatch();
  const formik = useFormik({
    initialValues: {
      user_id: props.setDataProfile.userid,
      bank_id: props.setCode,
      usac_account_number: accountNumber,
      usac_saldo: saldo,
      usac_type: props.setType,
    },
    onSubmit: async (values: any) => {
      const payload = {
        id: props.setUsersAcc,
      ...
      dispatch(UpdateUsersRequest(payload));
            ...
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              <div className="relative p-6 flex-auto">
                <div className="md:flex md:items-center mb-6">
                  ...
                  <div className="md:w-2/3">
                    <input
                      ...
                      value={formik.values.usac_account_number}
                ...
                <div className="md:flex md:items-center mb-6">
                  ...
                  <div className="md:w-2/3">
                    <select
                      className="text-slate-800 w-full py-2 px-4 bg-gray-200 border-2 border-gray-200 rounded leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                      id="inline-full-name"
                      name="usac_type"
                ...
                <div className="md:flex md:items-center mb-6">
                  ...
                  <div className="md:w-2/3">
                    <select
                      className="w-full py-2 px-4 bg-gray-200 border-2 border-gray-200 rounded leading-tight focus:outline-none text-slate-800 focus:bg-white focus:border-purple-500"
                      id="inline-full-name"
                      name="bank_id"
