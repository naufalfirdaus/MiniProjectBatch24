...
import { UpdateFintechRequest } from '@/redux-saga/action/fintechAction';
...
export default function EditFintechModal(props: setModal) {
  const dispatch = useDispatch();
  const formik = useFormik({
    initialValues: {
      id: props.setId,
      fint_code: props.setFintCode,
    ...
    onSubmit: async (values: any) => {
      ...
      dispatch(UpdateFintechRequest(payload));
    },
  });
