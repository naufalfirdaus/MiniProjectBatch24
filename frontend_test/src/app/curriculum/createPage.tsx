import { AddCurriculumReq } from "@/redux-saga/action/curriculumAction";
      ...
      <div className='py-10 px-10'>
        <div className='py-2'>
          <div className='grid grid-cols-2 gap-4'>
            <div className='flex justify-start font-black text-xl my-auto'>Create Curriculum</div>
            <div className='flex justify-end'><button onClick={() => props.setDisplay(false)} className="btn btn-primary my-auto">
        ...
        <div>
          <form action="" onSubmit={formik.handleSubmit}>
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => props.setDisplay(false)} className="btn btn-error my-auto">
                Cancel
              </button>
            </div>
          </form>
