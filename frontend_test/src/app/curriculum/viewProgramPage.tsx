...
export default function ViewProgram(props: any) {
  ...
  console.log(`Data View: ${JSON.stringify(program)}`);
      ...
      <div className="grid xl:grid-rows-3 xl:grid-flow-col gap-5 py-5">
        ...
        <div className="xl:row-span-full card card-compact w-full shadow-xl">
          <div className="py-5 px-5 flex justify-between">
            ...
            <EditModal program={programData} option={{ category, instructor }} setRefresh={setRefresh} setAlertInfo={setAlertInfo}/>
          </div>
          <hr />
            ...
            <div id="program_entity">
              ...
              <div className="ml-3 my-3">
                ...
                <div className="flex flex-col mb-3">
                  ...
                  <textarea id="predItemLearning" className="textarea textarea-bordered h-auto textarea-md capitalize" placeholder="What will you learn ?" value={program?.programEntityDescription?.predItemLearning?.items} disabled></textarea>
                </div>
                <div className="flex flex-col">
                  <label htmlFor="predDescription" className="mb-2 font-medium">Description</label>
                  <textarea id="predDescription" className="textarea textarea-bordered h-auto textarea-md capitalize" placeholder="Program Description" value={program?.programEntityDescription?.predDescription?.items} disabled></textarea>
                </div>
              </div>
            </div>
            <div id="sections">
              ...
              <div className="ml-3 mt-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  {/* <EditModal prog program={program} option={{ category, instructor }}/> */}
                </div>
                )
              }
              </div>
