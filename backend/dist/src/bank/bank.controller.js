...
bank_dto_1.BankDto;
let BankController = exports.BankController = class BankController {
...
], BankController.prototype, "getAll", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('bank_code')),
    __param(2, (0, common_1.Body)('bank_name')),
    __metadata("design:type", Function),
...
exports.BankController = BankController = __decorate([
    (0, common_1.Controller)('api/fintech/bank'),
